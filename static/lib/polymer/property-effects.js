...
import { root, isAncestor, isDescendant, get, translate, isPath, set, normalize } from '/lib/polymer/path.js';
/* for notify, reflect */

import { camelToDashCase, dashToCamelCase } from '/lib/polymer/case-map.js';
import { PropertyAccessors } from '/lib/polymer/property-accessors.js';
/* for annotated effects */

import { TemplateStamp } from '/lib/polymer/template-stamp.js';
import { sanitizeDOMValue } from '/lib/polymer/settings.js'; // Monotonically increasing unique ID used for de-duping effects triggered
