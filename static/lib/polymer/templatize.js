...
import { MutableData } from '/lib/polymer/mutable-data.js';
import { strictTemplatePolicy } from '/lib/polymer/settings.js';
import { wrap } from '/lib/polymer/wrap.js'; // Base class for HTMLTemplateElement extension that has property effects
